    ...
    <>
      <header className='top-navbar'>
        <div className="socials-media">
          <Link href=''><FontAwesomeIcon icon={faFacebook} size="2x" color="#1f456e" /></Link>
          <Link href=''><FontAwesomeIcon icon={faXTwitter} size="2x" color="#1f456e" /></Link>
          <Link href=''><FontAwesomeIcon icon={faLinkedin} size="2x" color="#1f456e" /></Link>
        </div>
        <div className="ksu">
          <Link href='https://kisiiuniversity.ac.ke/'>KISII UNIVERSITY</Link>
        </div>
      </header>
