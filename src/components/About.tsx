...
export default function About() {
  return (
  <div className="about">
      <span className="card_cont">
          <div className="about_card">
              <section className='img'>Image here...</section>
              <section className="content">
              Kisii University community led by The Deputy Vice Chancelor Prof. F. Mzee Awour partnering
